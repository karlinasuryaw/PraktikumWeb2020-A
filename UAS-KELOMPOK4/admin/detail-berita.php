...
<html lang="en">
  ...
  <div class="col-md-10 p-5 pt-2">
        <br>
        <h3><i class="fas fa-newspaper mr-2"></i>Detail Berita<hr></h3>
      <?php
      //koneksi database
      ...
      <form method="get" action="">
        ...
        <!-- data yg ditangkap, kemudian ditampilkan sebagai data non-editable pada form -->
            ...
            <tr>
                ...
                <td>
                  <div class="col-sm-10">  
                      <textarea style="resize:none;" readonly class="form-control-plaintext" cols="150" rows="6"><?php echo $d['isi_berita']; ?></textarea>
                  </div>
                </td>
            </tr>
            <tr>
