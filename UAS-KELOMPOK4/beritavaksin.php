    ...
    <section class="page-section" id="portfolio">
        <div class="container p-4">
            <div class="text-center portfolio1">
                <h1 class="section-headtext-uppercase">Berita Vaksin<br><br></h2>
            </div>
            <div class="row">
                <?php
                $data = mysqli_query($conn,"SELECT * FROM berita INNER JOIN kategori ON berita.id_kategori = kategori.id_kategori 
                                        INNER JOIN jurnalis ON berita.id_jurn = jurnalis.id_jurn WHERE kategori.nama_kategori='Vaksin' ORDER BY berita.id_berita");
