...
<html lang="en">
  ...
  <div class="col-md-10 p-5 pt-2"><br>
        <h3><i class="fas fa-newspaper mr-2"></i>Edit Berita<hr></h3>
      <?php
      //koneksi database
      ...
      ?>
      <form method="post" action="aksi_edit-berita.php" enctype="multipart/form-data">
        <table>
        <!-- data yg ditangkap, kemudian ditampilkan sebagai data non-editable pada form -->
            ...
            <tr>
                ...
                <td>
                  <div class="col-sm-10">
                    ...
                    <input type="text" name="judul" value="<?php echo $d['judul_berita']; ?>">
                  </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                  <div class="col-sm-10">
                    <?php
                    if ($d['nama_kategori']=='Vaksin'){
                        ?>
                        <input type="radio" name="kategori" value="1"> Kesehatan<br>
                        <input type="radio" name="kategori" value="2"> Ekonomi<br>
                        <input type="radio" name="kategori" checked value="3"> Vaksin<br>
                        <?php
                    }
                    else if ($d['nama_kategori']=='Ekonomi'){
                        ?>
                        <input type="radio" name="kategori" value="1"> Kesehatan<br>
                        <input type="radio" name="kategori" checked value="2"> Ekonomi<br>
                        <input type="radio" name="kategori" value="3"> Vaksin<br>
                        <?php
                    }
                    else if ($d['nama_kategori']=='Kesehatan'){
                        ?>
                        <input type="radio" name="kategori" checked value="1"> Kesehatan<br>
                        <input type="radio" name="kategori" value="2"> Ekonomi<br>
                        <input type="radio" name="kategori" value="3"> Vaksin<br>
                        <?php
                    }
            ...
            <tr>
                ...
                <td>
                  <div class="col-sm-10">  
                      <textarea style="resize:none;" name="isi" cols="100" rows="10"><?php echo $d['isi_berita']; ?></textarea>
                  </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                  <div class="col-sm-10">  
                    <input type="file" name="img_berita" accept="image/x-png,image/gif,image/jpeg">
                  </div>
                </td>
            </tr>
        </table>
