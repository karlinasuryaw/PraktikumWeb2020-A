      ...
      <form method="get" action="">
        ...
        <!-- data yg ditangkap, kemudian ditampilkan sebagai data non-editable pada form -->
            ...
            <tr>
                ...
                <td>
                    <div class="col-sm-10">
                        <textarea style="resize:none;" readonly class="form-control-plaintext" cols="50" rows="1"><?php echo $d['email_jurn']; ?></textarea>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" name="alamat" value="<?php echo $d['phone_jurn']; ?>">
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" name="alamat" value="<?php echo $d['birth_jurn']; ?>">
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" name="alamat" value="<?php echo $d['skill_jurn']; ?>">
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                  <label class="col-sm-2 col-form-label">Kartu Identitas</label>
                </td>
                <td>
                  <div class="col-sm-10">
                      <?php 
        ...
        <div class="col-sm-10">
            <br>
            <a href="edit-profile.php" class="btn btn-warning active text-white" role="button" aria-pressed="true">Edit Profile</a>
        </div>
      </form>
      <?php } ?>  
    </div>
